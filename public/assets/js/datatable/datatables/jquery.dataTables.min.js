...
(function (h) {
        ...
        var e = [],
            ...
            t = function (a, b) {
                if ("string" === typeof a) {
                    var c = a.indexOf("@");
                    -1 !== c &&
                        ((c = a.substring(c + 1)), R(a)(d, b.getAttribute(c)));
                }
            },
            m = function (a) {
                if (c === k || c === i)
    ...
    function Ea(a) {
        ...
        for (m = 0; m < i.length; m++)
            (o = c[i[m]]),
                null !== o.sWidth &&
                    ((o.sWidth = Db(o.sWidthOrig, k)), (t = !0));
    ...
    function Ib(a, b, c) {
        var d,
            ...
            b = function (b) {
                if (b && b.time) {
                    var g = r(a, "aoStateLoadParams", "stateLoadParams", [
                        a,
                        b,
                    ]);
                    if (
                        ...
                        b.search !== k &&
                            h.extend(a.oPreviousSearch, Ab(b.search));
                        if (b.columns) {
                            d = 0;
