                ...
                <li class="cart-nav onhover-dropdown">
                    ...
                    <div class="cart-dropdown onhover-show-div">
                        <div class="dropdown-title">
                            <h3>Cart </h3><a class="f-right" href="cart.html"> <i data-feather="shopping-bag">
                                </i></a>
                        </div>
                            ...
                            <li>
                                <div class="media"><img class="img-fluid b-r-5 me-3 img-50"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="cart-quantity"><span class="plus"><i
                                                    class="fa fa-plus"></i></span>
                                            <input class="count" type="text" name="qty" value="3"><span
                                                class="minus"><i class="fa fa-minus"></i></span>
                                        </div>
                                    </div>
                                    <div class="close-circle"><a href="#"><i class="me-1"
                                                data-feather="edit"></i></a><a href="#"><i
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4 text-center">
                                                    <div class="bookmark-content">
                                                        ...
                                                        <h5 class="mt-2"> <a href="user-profile.html">Profile</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                                <div class="col-4 text-center">
