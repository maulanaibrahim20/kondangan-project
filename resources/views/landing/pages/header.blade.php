        ...
        <div class="row">
            <div class="col-12">
                <nav class="navbar navbar-light p-0" id="navbar-example2"><a class="navbar-brand" href="javascript:void(0)">
                        <img class="img-fluid" src="../assets/images/logo/logo_dark.png" alt=""></a>
                    <ul class="landing-menu nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link"
                                href="http://docs.pixelstrap.com/zeta/document/">Documentation</a></li>
                        <li class="nav-item"><a class="nav-link"
                                href="https://docs.google.com/forms/d/e/1FAIpQLSe6hKUXw_By-pg7yabL0FxoTM02ZPTxoXy8PE3yboRuUCuyeA/viewform?">Hire
                                US</a></li>
                    </ul>
                    <div class="buy-block"><a class="btn-landing btn-white" href="{{ url('/login') }}">Login
                        </a>
